...
#define nrf_802154_priority_drop_hfclk_stop_Ignore() nrf_802154_priority_drop_hfclk_stop_CMockIgnore()
void nrf_802154_priority_drop_hfclk_stop_CMockIgnore(void);
#define nrf_802154_priority_drop_hfclk_stop_Expect() nrf_802154_priority_drop_hfclk_stop_CMockExpect(__LINE__)
void nrf_802154_priority_drop_hfclk_stop_CMockExpect(UNITY_LINE_TYPE cmock_line);
typedef void (* CMOCK_nrf_802154_priority_drop_hfclk_stop_CALLBACK)(int cmock_num_calls);
void nrf_802154_priority_drop_hfclk_stop_StubWithCallback(CMOCK_nrf_802154_priority_drop_hfclk_stop_CALLBACK Callback);
#define nrf_802154_priority_drop_hfclk_stop_terminate_Ignore() nrf_802154_priority_drop_hfclk_stop_terminate_CMockIgnore()
void nrf_802154_priority_drop_hfclk_stop_terminate_CMockIgnore(void);
#define nrf_802154_priority_drop_hfclk_stop_terminate_Expect() nrf_802154_priority_drop_hfclk_stop_terminate_CMockExpect(__LINE__)
void nrf_802154_priority_drop_hfclk_stop_terminate_CMockExpect(UNITY_LINE_TYPE cmock_line);
typedef void (* CMOCK_nrf_802154_priority_drop_hfclk_stop_terminate_CALLBACK)(int cmock_num_calls);
